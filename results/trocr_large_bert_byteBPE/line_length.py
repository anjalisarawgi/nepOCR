...
RESULTS_CSV = "results/trocr_large_bert_byteBPE/predictions.csv"
OUTPUT_PLOT = "results/trocr_large_bert_byteBPE/weighted_cer_by_length.png"
OUTPUT_CSV  = "results/trocr_large_bert_byteBPE/weighted_cer_by_length.csv"
...
# binned.to_csv(OUTPUT_CSV, index=False)
