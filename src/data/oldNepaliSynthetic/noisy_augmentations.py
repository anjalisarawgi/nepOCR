...
INPUT_DIR = "oldNepaliSynthetic_105k"
OUTPUT_DIR = "oldNepaliSynthetic_105k_vnoisy/images"
LABEL_FILE_IN = "oldNepaliSynthetic_105k/labels.json"
LABEL_FILE_OUT = "oldNepaliSynthetic_105k_vnoisy/labels.json"
...
def process_all_images():
    ...
    for entry in tqdm(original_labels, desc="Augmenting images", ncols=80):  # ⬅️ wrapped with tqdm
        ...
        try:
            ...
            noisy_labels.append({"image_path": output_path, "label": label})
