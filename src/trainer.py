...
set_seed(42)
wandb.init(project="oldNepali-ocr-logs", name="trocr-BERT-oldNepaliSynth-cbpe-200")
...
with open("corpus/oldNepaliSyntheticClean_nagari_oldNepali.txt", "r", encoding="utf-8") as f:
    tokenizer_obj.train_from_iterator(f, vocab_size=200)

tokenizer_dir = "tokenizer/charBPE/trocr_BERT_oldNepaliSynth_200/"
os.makedirs(tokenizer_dir, exist_ok=True)
tokenizer_obj.save(os.path.join(tokenizer_dir, "tokenizer.json"))
...
training_args = Seq2SeqTrainingArguments(
    output_dir="models/trocr-BERT-oldNepaliSynth-cbpe-200",
...
# Train and save
trainer.train()
trainer.save_model("models/trocr-BERT-oldNepaliSynth-cbpe-200")
tokenizer.save_pretrained("models/trocr-BERT-oldNepaliSynth-cbpe-200")
